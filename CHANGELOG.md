...
- Add a close button to the About page (#134)

## [0.2.1] - 2026-05-29

### Fixed

- Fix support of maps with a region crossing the antimeridian (#114)

### Changed

- Upgrade all dependencies, especially libzim 9.7.0 and Node.JS 26 (#117)
